    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 22) {
                ...
                GroupBox("Restore") {
                    VStack(alignment: .leading, spacing: 12) {
                        Text("Import accepts files up to 1 MiB and validates the connected keyboard's product, serial, model, firmware, button layout, and advertised capabilities before staging. Nothing is written until you review the relevant page and press Save; imported scripts and passwords still deserve the same care as live device data.")
                            .foregroundStyle(.secondary)
